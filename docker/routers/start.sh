...
cp -r /data/gm_bcos/cert/* ~/wecross-networks/routers-payment/127.0.0.1-8250-25500/conf/chains/gm_bcos/

cd ~/wecross-networks/routers-payment/127.0.0.1-8251-25501
bash add_chain.sh -t BCOS2.0 -n bcos
cp -r /data/bcos/cert/* ~/wecross-networks/routers-payment/127.0.0.1-8251-25501/conf/chains/bcos/
